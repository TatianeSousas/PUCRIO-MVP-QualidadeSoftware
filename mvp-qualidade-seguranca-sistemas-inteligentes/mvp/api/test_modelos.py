...
# Parâmetros    
url_dados = "database/covid.csv"
colunas = ['Entubado', 'Pneumonia', 'Hipertenso', 'Diabetes', 'Asma', 'Obesidade', 'Tabaco', 'Idade']

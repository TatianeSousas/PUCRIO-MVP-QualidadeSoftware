...
def predict(form: PacienteSchema):
    ...
    Args:
        ...
        Entubado (int): número de vezes que foi entubado: Pregnancies
        Pneumonia (int): se teve pneumonia: Glucose
        Hipertenso (int): se tem pressão alta: BloodPressure
        Diabetes (int): se tem diabetes : SkinThickness
        Asma (int): Se tem asma: Insulin
        Obesidade (int): Se está obeso
        Tabaco (int): Se fuma
        Idade (int): idade (anos): Age
